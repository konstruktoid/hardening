...
https://www.freedesktop.org/wiki/Software/systemd/[systemd] configuration examples.
...
KillMode=mixed
PrivateTmp=yes // <1>
ProtectSystem=full // <2>
ProtectHome=true // <3>
NoNewPrivileges=true // <4>
ReadOnlyDirectories=/var/www/html // <5>
CapabilityBoundingSet=~CAP_SYS_PTRACE // <6>
PrivateDevices=true // <7>
...
<5> "Directories listed in ReadOnlyDirectories= are accessible for reading only, writing will be refused even if the usual file access controls would permit this."
