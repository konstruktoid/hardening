...
== Tests
There are approximately 490 https://github.com/sstephenson/bats[Bats tests]
...
or by https://opencollective.com/konstruktoid_hardening#sponsor[sponsoring this project].
