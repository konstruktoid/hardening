...
versions. The script will generate link:tests/TESTRESULTS.adoc[TESTRESULTS.adoc].
...
improve the code by https://github.com/konstruktoid/hardening/pulls[create a pull request],
or https://opencollective.com/konstruktoid_hardening#sponsor[sponsor this project].
