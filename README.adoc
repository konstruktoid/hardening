...
If you're just interested in the security focused systemd configuration, it's available as https://github.com/konstruktoid/hardening/blob/master/systemd.adoc[separate document].
