...
. Change the configuration options in the `ubuntu.cfg` file. Make sure to update `CHANGEME=''` config else you will get the error message `Please read the code. Exiting`
