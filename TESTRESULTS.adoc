= Vagrant Ubuntu Test results - Mon Jun 10 12:02:33 UTC 2019
:icons: font
Number of tests: 494
...
----
Vagrant 2.2.4
ubuntu/bionic86 (virtualbox, 20190604.0.0)
ubuntu/cosmic86 (virtualbox, 20190604.0.0)
ubuntu/bionic86 (virtualbox, 20190604.0.0)
ubuntu/disco86 (virtualbox, 20190605.0.0)
----
...
not ok 473 Verify that DNSOverTLS is used in /etc/systemd/resolved.conf
not ok 492 Verify password protected GRUB
not ok 493 Verify Google 2FA in /etc/pam.d/sshd
not ok 494 Verify Yubico 2FA in /etc/pam.d/sshd
----
=== Lynis score:
----
...
not ok 109 Verify kernel.modules_disabled in /etc/sysctl.*
not ok 159 Verify sysctl runtime kernel.modules_disabled
not ok 434 Ensure user games is removed
not ok 435 Ensure user gnats is removed
not ok 436 Ensure user irc is removed
not ok 437 Ensure user list is removed
not ok 438 Ensure user news is removed
not ok 439 Ensure user sync is removed
not ok 440 Ensure user uucp is removed
not ok 492 Verify password protected GRUB
not ok 493 Verify Google 2FA in /etc/pam.d/sshd
not ok 494 Verify Yubico 2FA in /etc/pam.d/sshd
----
